  ...
  return (
    <div ref={ref} className="relative">
        <button
          ...
          className="relative p-2 lg:p-2 text-stone-600 hover:text-black transition-colors rounded-lg hover:bg-stone-100"
        >
          <HiOutlineBell className="w-5 h-5 sm:w-6 sm:h-6 lg:w-5 lg:h-5" />
        {unreadCount > 0 && (
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 sm:right-0 top-full mt-2 w-72 sm:w-96 bg-white rounded-xl shadow-xl border border-stone-200 overflow-hidden z-50 max-sm:left-1/2 max-sm:-translate-x-1/2"
          >
