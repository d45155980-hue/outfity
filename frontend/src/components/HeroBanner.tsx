...
export default function HeroBanner() {
  ...
  return (
    <section className="relative min-h-[50vh] sm:min-h-[70vh] lg:min-h-[90vh] overflow-hidden flex flex-col">
      ...
      <div className={`relative z-10 flex-1 flex items-end pb-32 lg:pb-36 ${current === 3 ? 'pb-40 lg:pb-48' : ''}`}>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <motion.span
                ...
                className="inline-block text-amber-400 text-[10px] sm:text-sm lg:text-base font-medium tracking-[0.3em] uppercase mb-2 sm:mb-4 drop-shadow-lg"
              >
                {s.subtitle}
              </motion.span>
              ...
              <motion.h1
                ...
                className="text-2xl sm:text-5xl lg:text-7xl font-bold text-white font-display mb-2 sm:mb-6 leading-tight drop-shadow-xl"
              >
                {s.title}
              </motion.h1>
              ...
              <motion.p
                ...
                className="text-gray-200 text-xs sm:text-base lg:text-lg max-w-[200px] sm:max-w-lg mb-3 sm:mb-8 leading-relaxed drop-shadow-md"
              >
                {s.description}
              </motion.p>
              ...
              >
                <Link
                  ...
                  className="inline-flex items-center justify-center px-5 sm:px-8 py-2 sm:py-3.5 bg-amber-500 text-black text-[11px] sm:text-sm font-semibold tracking-wide uppercase hover:bg-amber-400 transition-all rounded hover:shadow-lg hover:scale-105 active:scale-95"
                >
                  {s.primaryBtn.text}
                </Link>
                <Link
                  href={s.secondaryBtn.href}
                  className="inline-flex items-center justify-center px-5 sm:px-8 py-2 sm:py-3.5 border-2 border-white/40 text-white text-[11px] sm:text-sm font-semibold tracking-wide uppercase hover:border-white hover:bg-white/10 transition-all rounded hover:scale-105 active:scale-95"
                >
                  {s.secondaryBtn.text}
                </Link>
              </motion.div>
      ...
      <div className="hidden sm:flex absolute bottom-8 left-1/2 -translate-x-1/2 z-20 items-center gap-3">
        {slides.map((_, index) => (
          <button
            key={index}
